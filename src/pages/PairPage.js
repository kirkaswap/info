      ...
      <BlockedWrapper>
        <BlockedMessageWrapper>
          <AutoColumn gap="1rem" justify="center">
            ...
            <Link external={true} href={'https://gw-testnet-explorer.nervosdao.community/address/' + pairAddress}>{`More about ${shortenAddress(
              pairAddress
            )}`}</Link>
          </AutoColumn>
        </BlockedMessageWrapper>
              ...
              >
                <TokenDetailsLayout>
                  ...
                  <ButtonLight color={backgroundColor}>
                    <Link color={backgroundColor} external href={'https://gw-testnet-explorer.nervosdao.community/address/' + pairAddress}>
                      View on Blockscout ↗
                    </Link>
                  </ButtonLight>
                </TokenDetailsLayout>
